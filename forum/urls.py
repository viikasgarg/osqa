...
admin_url = url(r'^%s' % _('nimda/'), include(admin.site.urls))
...
core_urls = (
    ...
    url(r'^%s(?P<path>.*)$' % _('upfiles/'), 'django.views.static.serve', {'document_root':str(settings.UPFILES_FOLDER)}, name='uploaded_file',),
    url(r'^%s(?P<id>\d+)$'% _('attachments/'), app.readers.get_attachment_file_as_httpresponse, name='download_files'),
    ...
    url(r'^%s%s$' % (_('questions/'),_('all')), app.readers.questions, name='questions'),          ##vikas.garg
    url(r'^%s%s(?P<category>.*)/$' % (_('questions/'), _('ask/')), app.writers.ask, name='ask'),
    url(r'^%s%s$' % (_('questions/'), _('related_questions/')), app.commands.related_questions, name='related_questions'),
    url(r'^%s%s$' % (_('category/'), _('data/')), app.commands.category_selected, name='category_selected'),

    url(r'^%s%s$' % (_('questions/'),_('unanswered')), app.readers.unanswered, name='unanswered'),  ##vikas.garg
    url(r'^%s%s$' % (_('questions/'),_('unaccepted')), app.readers.unaccepted, name='unaccepted'),  ##vikas.garg
    ...
    #url(r'^%s' % _('tag_info/'), app.commands.tag_info, name='tag_info'),
    url(r'^%s' % _('matching_categories/'), app.commands.matching_categories, name='matching_categories'),
    url(r'^%s' % _('matching_mails/'), app.commands.matching_mails, name='matching_mails'),
    ...
    url(r'^%s$' % _('categories/'), app.readers.categories, name='categories'),

    url(r'^%s%s(?P<tag>.*)/$' % (_('questions/'),_('tags/')), app.readers.tag_questions, name='tag_questions'),
    url(r'^%s%s(?P<category>.*)/$' % (_('questions/'),_('category/')), app.readers.category_questions, name='category_questions'),

    url(r'^%s%s(?P<category>.*)/$' % (_('unanswered/'),_('category/')), app.readers.category_unanswered, name='category_unanswered'),    ##vikas.garg
    url(r'^%s%s(?P<category>.*)/$' % (_('unaccepted/'),_('category/')), app.readers.category_unaccepted, name='category_unaccepted'),   ## vikas.garg
    ...
    url(r'^%s$' % _('upload_attach/'), app.writers.upload_attachments, name='upload_attach'),
    url(r'^%s$' % _('delete_attach/'), app.writers.delete_attachments, name='delete_attach'),
